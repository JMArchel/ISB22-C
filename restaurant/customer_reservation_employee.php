<?php
	...
	if (isset($_POST['submitbtn']))
	{
		...
		{
			addreservationemployee($_POST['isonline'],
				$_POST['date'],
				$_POST['time'],
				$_POST['table_id'],
				$_POST['c_first_name'],
			...
			<dir class="col-lg-8 background">
				...
				<div class="col-lg-12">
					...
					<div class="form-group col-lg-6">
						...
						<select class="form-group form-control" name="employee_id">
							<option hidden>Select...</option>
							<?php
								foreach ($employee as $rows) 
								{
								?>
									<option value="<?php echo $rows['employee_id']; ?>"><?php echo $rows['e_last_name']; ?>,<?php echo $rows['e_first_name']; ?></option>
								<?php } ?>
						</select>
					</div>
				</div>
